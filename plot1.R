...
## Create a plot
hist(dataHouse$Global_active_power, col="red", main="Global Active Power", xlab="Global Active Power (kilowatts)")

## Save the plot in a png file
dev.copy(device=png, file="figure/plot1.png", width = 480, height = 480)
dev.off()
